...
SECRET_KEY = 'django-insecure-!#c^59eoxj*88w!0jjbtl9$q^(g7i91(-ozoaay-_1y9*r=4j='
...
CORS_ORIGIN_WHITELIST = (
    'http://127.0.0.1:8080',
    'http://smarttracker.grameenphone.com',
    'http://gp.efollowr.dingi.tech'
)
